...
```bash
curl -u admin:masataka5692 http://160.251.219.51/api/admin/self-update -X POST -H "Content-Type: application/json" -d '{"restart": false}'
```
...
```bash
curl -u admin:masataka5692 http://160.251.219.51/api/admin/deploy -X POST -H "Content-Type: application/json"
```
...
```bash
curl -u admin:masataka5692 http://160.251.219.51/api/admin/self-update -X POST -H "Content-Type: application/json" -d '{"restart": true}'
```
